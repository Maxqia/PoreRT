...
public final class MaterialConverter {
    ...
    private static final TypeConverter<Material, BlockType> BLOCK_TYPE_CONVERTER =
            TypeConverter.builder(Material.class, BlockType.class)
		            ...
		            .add(Material.BEETROOT_BLOCK, BlockTypes.BEETROOTS)
		            ...
		            .add(Material.CHORUS_FLOWER, BlockTypes.CHORUS_FLOWER)
		            .add(Material.CHORUS_PLANT,BlockTypes.CHORUS_PLANT)
		            .add(Material.COAL_ORE, BlockTypes.COAL_ORE)
		            .add(Material.COBBLESTONE, BlockTypes.COBBLESTONE)
		            .add(Material.COMMAND_CHAIN, BlockTypes.CHAIN_COMMAND_BLOCK)
		            .add(Material.COMMAND_REPEATING, BlockTypes.REPEATING_COMMAND_BLOCK)
		            ...
		            .add(Material.END_BRICKS, BlockTypes.END_BRICKS)
		            .add(Material.END_GATEWAY, BlockTypes.END_GATEWAY)
		            .add(Material.END_ROD, BlockTypes.END_ROD)
		            .add(Material.FIRE, BlockTypes.FIRE)
		            .add(Material.FROSTED_ICE, BlockTypes.FROSTED_ICE)
		            ...
		            .add(Material.GRASS_PATH, BlockTypes.GRASS_PATH)
		            ...
		            .add(Material.PURPUR_BLOCK, BlockTypes.PURPUR_BLOCK)
		            .add(Material.PURPUR_DOUBLE_SLAB, BlockTypes.PURPUR_DOUBLE_SLAB)
		            .add(Material.PURPUR_PILLAR, BlockTypes.PURPUR_PILLAR)
		            .add(Material.PURPUR_SLAB, BlockTypes.PURPUR_SLAB)
		            .add(Material.PURPUR_STAIRS, BlockTypes.PURPUR_STAIRS)
    ...
    private static final TypeConverter<Material, ItemType> ITEM_TYPE_CONVERTER =
            TypeConverter.builder(Material.class, ItemType.class)
		            ...
		            .add(Material.BEETROOT, ItemTypes.BEETROOT)
		            .add(Material.BEETROOT_SEEDS, ItemTypes.BEETROOT_SEEDS)
		            .add(Material.BEETROOT_SOUP, ItemTypes.BEETROOT_SOUP)
		            ...
		            .add(Material.BOAT_BIRCH, ItemTypes.BIRCH_BOAT)
		            .add(Material.BOAT_DARK_OAK,ItemTypes.DARK_OAK_BOAT)
		            .add(Material.BOAT_JUNGLE, ItemTypes.JUNGLE_BOAT)
		            .add(Material.BOAT_SPRUCE, ItemTypes.SPRUCE_BOAT)
		            .add(Material.BONE, ItemTypes.BONE)
		            .add(Material.BONE_BLOCK, ItemTypes.BONE_BLOCK)
		            ...
		            .add(Material.CHORUS_FLOWER, ItemTypes.CHORUS_FLOWER)
		            .add(Material.CHORUS_FRUIT, ItemTypes.CHORUS_FRUIT)
		            .add(Material.CHORUS_FRUIT_POPPED, ItemTypes.CHORUS_FRUIT_POPPED)
		            .add(Material.CHORUS_PLANT,ItemTypes.CHORUS_PLANT)
		            ...
		            .add(Material.COMMAND_CHAIN, ItemTypes.CHAIN_COMMAND_BLOCK)
		            .add(Material.COMMAND_MINECART, ItemTypes.COMMAND_BLOCK_MINECART)
		            .add(Material.COMMAND_REPEATING, ItemTypes.REPEATING_COMMAND_BLOCK)
		            ...
		            .add(Material.END_BRICKS, ItemTypes.END_BRICKS)
		            .add(Material.END_CRYSTAL, ItemTypes.END_CRYSTAL)
		            .add(Material.END_ROD, ItemTypes.END_ROD)
		            ...
		            .add(Material.GRASS_PATH, ItemTypes.GRASS_PATH)
		            ...
		            .add(Material.LINGERING_POTION, ItemTypes.LINGERING_POTION)
		            ...
		            .add(Material.MAGMA, ItemTypes.MAGMA)
		            ...
		            .add(Material.NETHER_WART_BLOCK, ItemTypes.NETHER_WART_BLOCK)
		            ...
		            .add(Material.PURPUR_BLOCK, ItemTypes.PURPUR_BLOCK)
		            .add(Material.PURPUR_PILLAR, ItemTypes.PURPUR_PILLAR)
		            .add(Material.PURPUR_SLAB, ItemTypes.PURPUR_SLAB)
		            .add(Material.PURPUR_STAIRS, ItemTypes.PURPUR_STAIRS)
		            ...
		            .add(Material.RED_NETHER_BRICK, ItemTypes.RED_NETHER_BRICK)
		            ...
		            .add(Material.SHIELD, ItemTypes.SHIELD)
		            ...
		            .add(Material.SPECTRAL_ARROW,ItemTypes.SPECTRAL_ARROW)
		            .add(Material.SPIDER_EYE, ItemTypes.SPIDER_EYE)
		            .add(Material.SPLASH_POTION, ItemTypes.SPLASH_POTION)
		            ...
		            .add(Material.STRUCTURE_BLOCK, ItemTypes.STRUCTURE_BLOCK)
		            .add(Material.STRUCTURE_VOID, ItemTypes.STRUCTURE_VOID)
		            ...
		            .add(Material.TIPPED_ARROW, ItemTypes.TIPPED_ARROW)
		            ...
		            .add(Material.WHITE_SHULKER_BOX, ItemTypes.WHITE_SHULKER_BOX)
